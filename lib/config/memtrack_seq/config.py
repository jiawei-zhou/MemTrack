...
# MODEL
cfg.MODEL = edict()
cfg.MODEL.STAGE = 'two_stage_train'
...
cfg.MODEL.ADJUST_LAYER = edict()
# cfg.MODEL.ADJUST_LAYER.Z_SIZE = 128
# cfg.MODEL.ADJUST_LAYER.X_SIZE = 256
cfg.MODEL.ADJUST_LAYER.OUT_DIM = 256

cfg.MODEL.SIDE_BACKBONE = edict()
cfg.MODEL.SIDE_BACKBONE.NUMS = 3
...
cfg.MODEL.MOTIONMODEL = edict()
cfg.MODEL.MOTIONMODEL.DIM = 64
cfg.MODEL.MOTIONMODEL.DROP = 0.1
cfg.MODEL.MOTIONMODEL.MLP_RATIO = 4

cfg.MODEL.MEMORYBLOCK = edict()
cfg.MODEL.MEMORYBLOCK.MEMORY_NUM = 2
cfg.MODEL.MEMORYBLOCK.MEMORY_MAX_NUM = 5
cfg.MODEL.MEMORYBLOCK.EXPAND = 2
cfg.MODEL.MEMORYBLOCK.NUM_HEADS = 8
cfg.MODEL.MEMORYBLOCK.OUT_DIM = 256
# MODEL.HEAD
cfg.MODEL.BINS = 400
cfg.MODEL.RANGE = 2
cfg.MODEL.SEQNUMS = 12
cfg.MODEL.SEQDIM = 256
cfg.MODEL.ENCODER_LAYER = 4
cfg.MODEL.SEQ_ENCODER_LAYER = 2
cfg.MODEL.SEQ_DECODER_LAYER = 6
...
cfg.TRAIN.CE_START_EPOCH = 0  # candidate elimination start epoch
cfg.TRAIN.CE_WARM_EPOCH = 20  # candidate elimination warm up epoch
...
cfg.DATA.STATIC_PROB = 0.8
cfg.DATA.REVERSE_PROB = 0.5
# DATA.TRAIN
