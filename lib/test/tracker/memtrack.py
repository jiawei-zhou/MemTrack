...
from lib.models.memtrack import build_histrack
from lib.test.tracker.basetracker import BaseTracker
import torch
from lib.utils.box_ops import box_cxcywh_to_xyxy
from lib.test.tracker.vis_utils import gen_visualization
from lib.test.utils.hann import hann2d,gaussian_window
...
class HisTrack(BaseTracker):
    def __init__(self, params, dataset_name):
        super(HisTrack, self).__init__(params)
        network = build_histrack(params.cfg, training=False)
