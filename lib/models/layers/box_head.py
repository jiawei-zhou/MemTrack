...
class CenterPredictor(nn.Module, ):
    ...
    def cal_bbox(self, score_map_ctr, size_map, offset_map, return_bias=False):
        ...
        if return_bias:
            bias = torch.cat([idx_x-self.feat_sz/2+offset[0,0],idx_y-self.feat_sz/2+offset[0,1]]).squeeze()
            return bbox, bias
        return bbox
